...
(function($){
    ...
    ikr.darkbox.show = function(j_imgctn){
        ...
        if(!is_shown){
            j_darkbox.hide();
            j_darkbox.css('visibility', 'visible');
    ...
    ikr.darkbox.hide = function(){
        is_shown = false;
        j_darkbox.fadeOut(function(){
            j_darkbox.css('visibility', 'hidden');
            j_darkbox.show();
        });
...
(function($){
    ...
    function init(){
        ...
        ikr.j_imgls.on('click', 'img', function(evt){
            ...
            ikr.j_imgls.trigger(E_SELECTION_CHANGE);
        }).
        on(E_SELECTION_CHANGE, function(evt){
    ...
    function loadmore(){
        ...
        $('<div />').load(API_LSMINE_URI.replace('{till}', 
            ...
            $.each(j_tmp.find('.imgctn'), function(idx, el){
                var j_t = $(el);
